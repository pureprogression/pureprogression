                        ...
                        {(tempOrder || selectedExercises).map((exercise, index) => {
                          ...
                          return (
                            <motion.div 
                              ...
                              className={`flex items-center gap-4 p-4 rounded-lg bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 group relative overflow-hidden ${
                              ...
                              style={{
                                ...
                                opacity: swipedExercise?.id === exercise.id ? swipeOpacity : undefined,
