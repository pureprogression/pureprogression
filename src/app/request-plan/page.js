...
export default function RequestPlanPage() {
  ...
  return (
    <>
      ...
      {/* Поп-ап успешной отправки через Portal */}
          ...
          {showSuccess && (
            ...
            >
              ...
              <motion.div
                ...
                className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl px-8 py-6 text-center text-white shadow-2xl max-w-md mx-4"
              >
                <p className="text-xl font-semibold mb-2">
                  {language === 'ru' ? 'Данные отправлены' : 'Data sent'}
                </p>
                <p className="text-sm text-gray-300 mb-6">
                  {language === 'ru' ? 'Мы скоро подготовим ваш план' : 'We will prepare your plan soon'}
                </p>
                <button
                  onClick={handleCloseSuccess}
                  className="w-full py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-black font-semibold rounded-lg hover:from-yellow-400 hover:to-orange-400 transition-all"
                >
                  {language === 'ru' ? 'ОК' : 'OK'}
                </button>
              </motion.div>
